...
';
        ...
        */
        ...
        function insert_rewrite_rules( $rules ) {
            ...
            //portal page
            $newrules[wpc_client_get_slug( 'portal_page_id', false, false ) . '/(.+?)/?$'] = 'index.ctp?wpc_page=portal_page&wpc_page_value=$matches[1]';

            //preview for HUB
            $newrules[wpc_client_get_slug( 'hub_page_id', false, false ) . '/(\d*)/?$'] = 'index.ctp?wpc_page=hub_preview&wpc_page_value=$matches[1]';
...
//    add_action('wp_logout', array('wpc_rulLogoutFunctionCollection', 'logout_redirect'), 10);
    ...
    function wpc_client_permissions_admin_redirect() {
        ...
        if($result !== false)
            wp_redirect(get_option('siteurl') . '/wp-admin/index.ctp?permissions_error=true');
    }
